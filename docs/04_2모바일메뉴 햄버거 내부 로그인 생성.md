...
<div class="d-block d-lg-none">
    <div class="quick-schedule">
        <p class="fs-13 font-serif mb-2 fw-bold ">진료시간 <span class="text-submain-light fs-8">*실시간 반영되고 있습니다.</span> </p>
        <ul class="list-unstyled d-flex flex-wrap row-gap-2 rounded fs-11 text-main-dark fw-bold">
            <li class="w-50">
